        ...
        <AnimatePresence>
          {active && (
            ...
            >
              ...
              />
              {/* full red+blue gradient disk spinning slowly behind the logo —
                  dimmer, strongest toward the center and fading to transparent
                  at the edges, counter to the cone */}
              <motion.div
                className="absolute left-1/2 top-1/2 size-16 -translate-x-1/2 -translate-y-1/2 rounded-full blur-[2px]"
                style={{
                  background:
                    "conic-gradient(from 0deg, rgba(239,68,68,0.6), rgba(59,130,246,0.6), rgba(239,68,68,0.6))",
                  WebkitMaskImage:
                    "radial-gradient(closest-side, #000 0%, #000 28%, transparent 95%)",
                  maskImage:
                    "radial-gradient(closest-side, #000 0%, #000 28%, transparent 95%)",
                }}
                animate={{ rotate: -360 }}
